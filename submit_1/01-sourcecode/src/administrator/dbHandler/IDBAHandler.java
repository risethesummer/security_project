...
public interface IDBAHandler {
    ...
    Collection<DBObject> getInsideObjects(String name);
    Collection<DBObject> getInsideObjectsToGrant(String name);
    Collection<DBObject> getOutsideObjects(String name);
}
